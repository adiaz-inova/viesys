...
<body>
  ...
  <div id="vie_encabezado">
    <div id="vie_logo_content"><div id="vie_logo"></div></div>
    <div id="topmenu">
...
<div class="settings-content">
  <div class="boxed-group">
    ...
    <div style="color: #F92672;font-weight:bold;text-align:center;"><?php
    if (isset($auth_message) && $auth_message!='')
      echo $auth_message;
    ?>
      <br>
    ...
    <div id="vie_pie">VIE | Very Important Events<br />2012 &copy Todos los derechos reservados.</div>
