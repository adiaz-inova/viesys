...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="includes/js/hacks.js"></script>
                    ...
                    buttons: [
                        {
                            ...
                            click: function() {
                                ...
                                for  ( i=0; i<arreglo_info.length-minus; i++ )
                                {
                                    ...
                                    // Crear la cadena de parï¿½metros POST
                                    var contactos='';
                                    ...
                                    //AÃ±adir los contactos a los parÃ¡metros POST
                                    params += escape(contactos);

                                }

                                //Quitar el ï¿½ltimo '*' porque no es necesario
                            ...
                            click: function() {
                                ...
                                for  ( i=0; i<arreglo_ordenes.length-minus; i++ )
                                {
                                    ...
                                    */
                                    ...
                                    //Se cambia el Ãºltimo | por un * para indicar que siguen los datos de otro dominio y no de otro DNS.
                                    params=params.substr( 0, params.length-1 )+'*';
                                }

                                if(error==false)
                                {
                                    params='action='+forma+'&info_dns='+params.substr( 0, params.length-1 )+'&datos_ordenes=' + domain; //Le quitamos el ï¿½ltimo *
                                    $(".contentMask").mask('Cargando');
                                    $.ajax({
                                        url: 'dataAccess.php',
                                        type: 'POST',
...
function bindEvents_SetupUpgrade(){
    ...
    $('#periodicidades input').live('click',function(){  
       ...
       if(total!=0){
        ...
        <meta >
            <title> *Cliente Neubox 3.0 -  </title>
            <script type="text/javascript" language="javascript">
                var currentMenu = '';
            </script>
        </meta>
    ...
    <body>
        ...
        <div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
            <div id="sidebar">
                ...
                <img id="logo" src="img/neubox_logo_de.png" alt="Neubox Logo"/>
                <ul id="main-nav">  <!-- Accordion Menu -->
                    <li>
                        <a href="#" class="menuHome "> <!--Home-->
                            Home                        </a>
                    </li>
                    <li>
                <a href="#" class="nav-top-item ">
                    Informaci&oacute;n de Usuario                </a>
                <ul id="subMenu">
            <li id='sub1' class="opcionMenu"><a class='current' href='#'>Mis Datos</a></li>
        </ul>
        <ul id="subMenu">
            <li id="sub2" class="opcionMenu"><a class="current" href="#">Datos de Facturaci&oacute;n</a></li>
        </ul>
            </li>
                    <li>
                <a href="#" class="nav-top-item ">
                    Administraci&oacute;n de Dominios                </a>
                <ul id="subMenu">
            <li id="sub5" class="opcionMenu"><a class="current" href="#">Lista de Dominios</a></li>
        </ul>
        <ul id="subMenu">
            <li id="sub9" class="opcionMenu"><a class="current" href="#">Contactos de WhoIs</a></li>
        </ul>
        <ul id="subMenu">
            <li id="sub12" class="opcionMenu"><a class="current" href="#">Backorders</a></li>
        </ul>
            </li>
                    <li>
                <a href="#" class="nav-top-item ">
                    Planes de Hosting                </a>
                <ul id="subMenu">
            <li id="sub7" class="opcionMenu"><a class="current" href="#">Mis Planes</a></li>
        </ul>
            </li>
                    <li>
                <a href="#" class="nav-top-item ">
                    Facturas Electr&oacute;nicas                </a>
                <ul id="subMenu">
            <li id="sub10" class="opcionMenu"><a class="current" href="#">Facturas Electr&oacute;nicas</a></li>
        </ul>
            </li>
                    <li>
                <a href="#" class="nav-top-item ">
                ...
                <ul id="subMenu">
            <li id="sub11" class="opcionMenu"><a class="current" href="#">Herramientas SEO</a></li>
        </ul>
            </li>
                    <li>
                <a href="#" class="nav-top-item ">
                    Descargas
                        ...
                        <ul id="subMenu">
                    <li class="opcionMenu"><a class="current" href="downloads/MANUAL-ESP01.pdf" target="_blank">Manual T&eacute;cnico</a></li>
                </ul>
                            </li>
                        </ul>
            </div>
            ...
            <div id="main-content">
                <div id="header">
                            <div id="logOut">
                                <a href="/clientes/index.php?salir=true" >
                                    Cerrar Sesi&oacute;n                                </a>
                            </div>
                            <h2 id="head-user" class="normal">
                                                            </h2>
                            <div id="head-date" class="normal">
                                20 de Septiembre de 2012                            </div>
                        </div>
                <!-- Page Title-->
                <h3 id="title" class="sub_caption_section_basic normal">
                </h3>
                <!-- Contenido para Ajax-->
                <div id="content">
                </div>
        ...
        <!-- Dialogos -->
        <div>
            <div id="agb_upgrade_dialog" title="T&eacute;rminos y condiciones" style="display: none;">
                <p><strong>Al contratar</strong> cualquiera de nuestros paquetes obtienes la versi&oacute;n
                b&aacute;sica de Sitio en Minutos si quieres obtener la <strong>versi&oacute;n completa</strong> puedes
                hacerlo con un pago trimestral de $559 con lo que <strong>obtienes todos los beneficios</strong> de este
                servicio.</p>
                <p><strong>Al hacer el cambio</strong> a la versi&oacute;n b&aacute;sica de Sitio En Minutos toda
                <strong>tu informaci&oacute;n seguir&aacute; disponible</strong> para modificar tu sitio. Sin embargo en caso
                de no realizar el pago de este servicio perder&aacute;s los datos asociados a este teniendo que crear nuevamente
                tu sitio web.</p>
                <p>Al realizar <strong>upgrade</strong> del plan que tienes contratado actualmente solamente
                deber&aacute;s pagar la diferencia entre un plan y otro, en caso de tener ya m&aacute;s de 6 meses con tu plan
                actual pagaras s&oacute;lo la mitad de este monto.</p>
            </div>
            <div id="show_opts_upgrade" style="display: none;"></div>
            <div id="cancel_plan_upgrade_dialog" style="display: none;"></div>
            <div id="cancel_cm4all_upgrade_dialog" style="display: none;"></div>
        </div>
        <!-- Cierre de dialogos -->
    </body>
</html>